...
class CategorySeeder {
  async run() {
    ...
    const Bebidas = await Category.create({ name: "Bebidas" });
    ...
    const Lacticinios = await Category.create({ name: "Lacticínios" });
    ...
    const Limpeza = await Category.create({ name: "Limpeza" });
    ...
    const Animais = await Category.create({ name: "Animais" });
